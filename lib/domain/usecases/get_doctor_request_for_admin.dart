...
class GetDoctorRequestForAdmin extends UseCase<List<DoctorEntity>, NoParams> {
  final AppRepository appRepository;

  GetDoctorRequestForAdmin(this.appRepository);

  @override
  Future<Either<AppError, List<DoctorEntity>>> call(NoParams params) async {
    return await appRepository.getDoctorRequestForAdmin();
  }
}
