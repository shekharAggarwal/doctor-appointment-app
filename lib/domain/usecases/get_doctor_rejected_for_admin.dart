...
class GetDoctorRejectedForAdmin extends UseCase<List<DoctorEntity>, NoParams> {
  final AppRepository appRepository;

  GetDoctorRejectedForAdmin(this.appRepository);

  @override
  Future<Either<AppError, List<DoctorEntity>>> call(NoParams params) async {
    return await appRepository.getDoctorRejectedForAdmin();
  }
}
