...
class TopDoctorProfile extends StatefulWidget {
  final String name;

  const TopDoctorProfile({Key? key, required this.name}) : super(key: key);

  @override
  State<TopDoctorProfile> createState() => _TopDoctorProfileState();
}

class _TopDoctorProfileState extends State<TopDoctorProfile> {
  late final RemoveLogin removeLogin;
